...
public class FrontCheckoutController {
    ...
    private static final Logger logger = Logger.getLogger(FrontCheckoutController.class.getName());
    ...
    public String showCheckoutMain() {
        return "checkout/checkout/front/FrontIndex";
    }
    ...
    public String getAllCheckouts(Model model) {
        try {
            ...
            return "checkout/checkout/front/FrontGetAllCheckouts";
    ...
    public String getCheckout(@RequestParam String checkoutId, Model model) {
        try {
            ...
            return "checkout/checkout/front/FrontGetCheckout";
        } catch (DataAccessException e) {
    ...
    public String showAddForm(Model model) {
        try {
            ...
            return "checkout/checkout/front/FrontInsertCheckout";
        } catch (DataAccessException e) {
    ...
    public String showUpdateForm(@RequestParam String checkoutId, Model model) {
        try {
            model.addAttribute("checkout", checkoutService.getCheckout(checkoutId));
            return "checkout/checkout/front/FrontGetUpdateCheckout";
        } catch (DataAccessException e) {
    ...
    public String searchCheckoutsByTel(@RequestParam String customerTel, Model model) {
        try {
            ...
            return "checkout/checkout/front/FrontSearchResults";
        } catch (DataAccessException e) {
    ...
    public String getDailySalesReport(Model model) {
        try {
            ...
            return "checkout/checkout/front/FrontDailySalesReport";
        } catch (DataAccessException e) {
    ...
    public String getCheckoutSummary(Model model) {
        try {
            ...
            return "checkout/checkout/front/FrontCheckoutSummary";
        } catch (DataAccessException e) {
    ...
    public String getCheckoutsByDateRange(
        ...
        try {
            ...
            return "checkout/checkout/front/FrontCheckoutsByDateRange";
        } catch (DataAccessException e) {
