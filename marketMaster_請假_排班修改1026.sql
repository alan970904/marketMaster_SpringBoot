...
VALUES
    ('EX00000001', 'IM005', '0912345678', 6, 1, '2024-10-15'),  -- 陳大文 累積64點 兌換雞肉1份 使用6點
    ('EX00000002', 'IM007', '0923456789', 5, 1, '2024-10-16'),  -- 林小美 累積19點 兌換蛤蠣1份 使用5點
    ('EX00000003', 'IM006', '0934567890', 3, 1, '2024-10-17'),  -- 王建國 累積19點 兌換小黃瓜1份 使用3點
    ('EX00000004', 'IM008', '0945678901', 3, 1, '2024-10-18'),  -- 張美玲 累積4點 兌換高麗菜1份 使用3點
    ('EX00000005', 'IM009', '0956789012', 3, 1, '2024-10-19'),  -- 李志明 累積8點 兌換魚1份 使用3點
    ('EX00000006', 'IM005', '0967890123', 6, 1, '2024-10-20'),  -- 吳淑芬 累積24點 兌換雞肉1份 使用6點
    ('EX00000007', 'IM007', '0978901234', 5, 1, '2024-10-21'),  -- 黃麗華 累積6點 兌換蛤蠣1份 使用5點
    ('EX00000008', 'IM009', '0989012345', 4, 1, '2024-10-22'),  -- 劉俊傑 累積15點 兌換魚1份 使用4點
    ('EX00000009', 'IM008', '0990123456', 5, 1, '2024-10-23'),  -- 周雅婷 累積9點 兌換空心菜1份 使用5點
    ('EX00000010', 'IM010', '0901234567', 3, 1, '2024-10-24'); -- 謝宗翰 累積18點 兌換高麗菜1份 使用3點
...
VALUES
    ('IM001', 'PMS001', 7, 100, '2024-06-01', '2024-08-31', 0), -- 豬肉 商品價格200 兌換點數設定為7點
    ('IM002', 'PVF001', 2, 50, '2024-06-01', '2024-08-31', 0), -- 玉米 商品價格20 兌換點數設定為2點
    ('IM003', 'PMS002', 8, 30, '2024-06-01', '2024-08-31', 0), -- 牛肉 商品價格200 兌換點數設定為8點
    ('IM004', 'PVF002', 5, 60, '2024-06-01', '2024-08-31', 0), -- 番茄 商品價格30 兌換點數設定為5點
    -- 第二批活動商品(進行中)  -- 10月到12月（目前為活動期間，狀態設為 1）
    ('IM005', 'PMS003', 6, 120, '2024-10-01', '2024-12-31', 1), -- 雞肉 商品價格200 兌換點數設定為6點
    ('IM006', 'PVF003', 3, 80, '2024-10-01', '2024-12-31', 1), -- 小黃瓜 商品價格15 兌換點數設定為3點
    ('IM007', 'PMS004', 5, 40, '2024-10-01', '2024-12-31', 1), -- 蛤蠣 商品價格200 兌換點數設定為5點
    ('IM008', 'PVF004', 5, 70, '2024-10-01', '2024-12-31', 1), -- 空心菜 商品價格60 兌換點數設定為5點
    ('IM009', 'PMS005', 8, 150, '2024-10-01', '2024-12-31', 1), -- 魚 商品價格200 兌換點數設定為8點
    ('IM010', 'PVF005', 3, 45, '2024-10-01', '2024-12-31', 1), -- 高麗菜 商品價格70 兌換點數設定為3點
    -- 第三批活動商品(尚未開始)  -- 1月到2月（活動未開始，狀態設為 0）
    ('IM011', 'PMS001', 7, 100, '2025-01-01', '2025-02-28', 0), -- 豬肉 商品價格200 兌換點數設定為7點
    ('IM012', 'PMS002', 9, 90, '2025-01-01', '2025-02-28', 0), -- 牛肉 商品價格200 兌換點數設定為9點
    ('IM013', 'PVF001', 2, 50, '2025-01-01', '2025-02-28', 0), -- 玉米 商品價格20 兌換點數設定為2點
    ('IM014', 'PVF002', 3, 60, '2025-01-01', '2025-02-28', 0); -- 番茄 商品價格30 兌換點數設定為3點
...
VALUES
    ...
    -- 兌換使用點數記錄
    ('0912345678', '', 'EX00000001', -6, '2024-11-08', 'use'),  -- 陳大文 使用6點，剩餘2點
    ('0923456789', '', 'EX00000002', -5, '2024-11-08', 'use'),  -- 林小美 使用5點，剩餘7點
    ('0934567890', '', 'EX00000003', -3, '2024-11-08', 'use'),  -- 王建國 使用3點，剩餘2點
    ('0945678901', '', 'EX00000004', -3, '2024-11-09', 'use'),  -- 張美玲 使用3點，剩餘1點
    ('0956789012', '', 'EX00000005', -3, '2024-11-09', 'use'),  -- 李志明 使用3點，剩餘0點
    ('0967890123', '', 'EX00000006', -6, '2024-11-09', 'use'),  -- 吳淑芬 使用6點，剩餘1點
    ('0978901234', '', 'EX00000007', -5, '2024-11-09', 'use'),  -- 黃麗華 使用5點，剩餘1點
    ('0989012345', '', 'EX00000008', -4, '2024-11-10', 'use'),  -- 劉俊傑 使用4點，剩餘0點
    ('0990123456', '', 'EX00000009', -5, '2024-11-10', 'use'),  -- 周雅婷 使用5點，剩餘4點
    ('0901234567', '', 'EX00000010', -3, '2024-11-10', 'use'); -- 謝宗翰 使用3點，剩餘15點
